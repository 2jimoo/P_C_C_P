...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/user/PycharmProjects/pythonProject/venv2'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/user/PycharmProjects/pythonProject/venv2/bin/deactivate.nu'
